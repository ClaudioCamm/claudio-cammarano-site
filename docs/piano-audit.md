...
- [ ] **L1** Correzioni rapide EN — tagline "Ideas, claims, checks"; riga "Paper α1, in preparation → Project status"; link "Not a researcher? Try the quick test →"; niente hreflang/translation fra le due home
