...
description: "The paper's eight-section architecture is finalized, with Peirce as methodological foundation and the framework situated as a direct continuation of Quattrociocchi et al.'s work on epistemia."
documents:
...
Document: {% labdoc "04_struttura_paper_v2.pdf" %} (v3 update). References: 56 entries in {% labdoc "epistemologia_ai_bibliografia_definitiva.bib" %}.
